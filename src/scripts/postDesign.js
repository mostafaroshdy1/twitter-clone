...
const postCreation = document.querySelector('.postCreation');
const postCreationDesign = `<div class="mt-4 border-bottom border-dark postCreation">
<div class="row ">
    <div class="col-1">
...
const postDesign = ` <div class="post border-bottom border-top border-dark">
<div class="row mt-4">
    <div class="col-1">
        <img src="../../public/images/user4.jpg" class="img-fluid rounded-circle img-thumbnail"
...
<div class="row">
    ...
    <div class="col-10">
        <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed architecto repellat
            soluta
            provident minus id, vero, dignissimos aut nisi, consequuntur voluptate a culpa
            cumque
            praesentium commodi laboriosam veniam adipisci consequatur!
        </p>
        <img class="img-fluid rounded-5" src="../../public/images/GI86Lp3W4AAtN5r.png" alt="">
    </div>
</div>
<div class="row">
...
postCreation.innerHTML = postCreationDesign;
postSection.innerHTML = postDesign;